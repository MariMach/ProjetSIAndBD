...
<li>
 <div class="imgcontainer">
  ...
  <li><a class="active" href="EspaceDirecteur.jsp">Bienvenue</a></li>
	                ...
	                <div class=" col-md-9 col-lg-9 "> 
	                  <table class="table table-user-information">
		            	...
		            	<tr>
	                        ...
	                        <td style="font-size: 14px ;"> <%=dir.getNom_directeur()%> </td>
	                      </tr>
	                      
	                      <tr>
	                        <td style="font-size: 14px ;"><b>Prenom : </b></td>
	                        <td style="font-size: 14px ;"><%=dir.getPrenom_directeur()%></td>
	                      </tr>
	                       ...
	                       <tr>
	                        ...
	                        <td style="font-size: 14px ;"><%=dir.getProfession_directeur() %></td>
	                      </tr>
	                      
	                        <tr>
	                        <td style="font-size: 14px ;"><b>Sexe : </b></td>
	                        <td style="font-size: 14px ;"><%=dir.getSexe_directeur() %></td>
	                      </tr>
	                      
	                      <tr>
			                     <td style="font-size: 14px ;"><b>Adresse : </b></td>
			                     <td style="font-size: 14px ;"><%=dir.getAddress_directeur() %></td>
	                     </tr>
	                      
	                      <tr>
	                        <td style="font-size: 14px ;"><b>Email : </b></td>
	                        <td style="font-size: 14px ;"><%=dir.getEmail_directeur() %></td>
	                      </tr>
	                      
	                      <tr>
	                        <td style="font-size: 14px ;"><b>Telephone : </b></td>
	                        <td style="font-size: 14px ;"><%=dir.getNum_directeur() %><br></td>    
	                      </tr>
