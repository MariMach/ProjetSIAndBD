...
<li>
 <div class="imgcontainer">
  ...
  <li><a class="active" href="EspaceChercheurEquipe.jsp">Equipes</a></li>
...
<div style="margin-left:20%;padding:70px 16px;height:1000px;">
		...
		ArrayList<Equipe> equipes = chercheurfunctions.getEquipesChercheurs(id_ch);
		    ...
		    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
		      <div class="card-body">
	                  ...
	                  <table class="table table-user-information">
		            	...
		            	<tr>
	                        <td style="font-size: 14px ;"><b>Description Equipe : </b></td>
	                        <td style="font-size: 14px ;"><%=eq.getDescription_equipe()%></td>
	                      </tr>
	                  
	                   
	                       <tr>
			                     <td style="font-size: 14px ;"><b>Etablissement Equipe: </b></td>
			                     <td style="font-size: 14px ;"><%=eq.getEtablissement_equipe()%></td>
	                     </tr>
	                   	  
	                         <tr>
	                        <td style="font-size: 14px ;"><b>Nom Laboratoire : </b></td>
	                        <td style="font-size: 14px ;"><%=Laboratoiresfunctions.getLaboratoire(eq.getId_laboratoire()).getNom_laboratoire()%></td>
	                      </tr>
	                      
	                        <tr>
	                        <td style="font-size: 14px ;"><b>Type : </b></td>
	                        <td style="font-size: 14px ;"><%=chercheurfunctions.getTypechercheur(id_ch, eq.getId_equipe()) %></td>
	                      </tr>
	                      ...
	                      <tr>
	                        ...
	                        <%  ArrayList<Chercheur> chs= equipefunctions.getEquipeMembres(eq.getId_equipe()); %>
