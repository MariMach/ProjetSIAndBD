...
<li>
 <div class="imgcontainer">
  ...
  <li><a class="active" href="EspaceResponsableDemandes.jsp">Demandes</a></li>
...
<div style="margin-left:20%;padding:50px 16px;height:1000px;">
						...
						<% ArrayList<Demande> demandes = new ArrayList<Demande>(); %>	
								...
								<% demandes = demandefunctions.historiquesDemandeLaboratoire(lab.getId_laboratoire()); %>
	    ...
	    <% for (Demande dem : demandes) { %>
                    ...
                    <td  data-target="x">
                   	 <form action="servletmodifierresp" method="post"> 
