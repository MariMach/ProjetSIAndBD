...
<li>
 <div class="imgcontainer">
  ...
  <li><a class="active" href="EspaceResponsable.jsp">Bienvenue</a></li>
  <li><a href="EspaceResponsableLaboratoire.jsp">Laboratoire</a></li>
	                ...
	                <div class=" col-md-9 col-lg-9 "> 
	                  <table class="table table-user-information">
		            	...
		            	<tr>
	                        ...
	                        <td style="font-size: 14px ;"><%=resp.getNom_responsable() %></td>
	                      </tr>
	                      
	                      <tr>
	                        <td style="font-size: 14px ;"><b>Prenom : </b></td>
	                        <td style="font-size: 14px ;"><%=resp.getPrenom_responsable() %></td>
	                      </tr>
	                   
	                       <tr>
			                     <td style="font-size: 14px ;"><b>Etablissement : </b></td>
			                     <td style="font-size: 14px ;"><%=resp.getEtab_responsable()%></td>
	                     </tr>
	                   	  
	                         <tr>
	                        <td style="font-size: 14px ;"><b>Profession : </b></td>
	                        <td style="font-size: 14px ;"><%=resp.getProfession_responsable()%></td>
	                      </tr>
	                      
	                        <tr>
	                        <td style="font-size: 14px ;"><b>Sexe : </b></td>
	                        <td style="font-size: 14px ;"><%=resp.getSexe_responsable() %></td>
	                      </tr>
	                      
	                      <tr>
			                     <td style="font-size: 14px ;"><b>Adresse : </b></td>
			                     <td style="font-size: 14px ;"><%=resp.getAddress_responsable() %></td>
	                     </tr>
	                      
	                      <tr>
	                        <td style="font-size: 14px ;"><b>Email : </b></td>
	                        <td style="font-size: 14px ;"><%=resp.getEmail_responsable() %></td>
	                      </tr>
	                      
	                      <tr>
	                        <td style="font-size: 14px ;"><b>Telephone : </b></td>
	                        <td style="font-size: 14px ;"><%=resp.getNum_responsable() %><br></td>    
	                      </tr>
