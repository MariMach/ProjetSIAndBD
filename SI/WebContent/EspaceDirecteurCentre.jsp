...
<li>
 <div class="imgcontainer">
  ...
  <li><a   class="active" href="EspaceDirecteurCentre.jsp">Centre</a></li>
	        ...
	        <div class="col-lg-offset-4 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
	          ...
	          <div class="panel panel-info">
	            <div class="panel-heading">
	              <h2 class="panel-title" style="font-size: 20px ;"><b>Informations du Centre</b></h2>
	            </div>
	              ...
	              <div class="row">
	                ...
	                <div class=" col-md-9 col-lg-9 "> 
	                  <table class="table table-user-information">
		            	...
		            	<tr>
	                        <td style="font-size: 14px ;"><b>Nom Centre : </b></td>
	                        <td style="font-size: 14px ;"> <%=dir.getNom_centre()%> </td>
	                      </tr>
	                      
	                      <tr>
	                        <td style="font-size: 14px ;"><b>Description Centre : </b></td>
	                        <td style="font-size: 14px ;"><%=dir.getDescription_centre()%></td>
	                      </tr>
	                   
	                       <tr>
			                     <td style="font-size: 14px ;"><b>Etablissement Centre: </b></td>
			                     <td style="font-size: 14px ;"><%=dir.getEtab_centre()%></td>
	                     </tr>
	                   	  
	                         <tr>
	                        <td style="font-size: 14px ;"><b>Directeur Centre : </b></td>
	                        <td style="font-size: 14px ;"><%=dir.getNom_directeur()%> <%=dir.getPrenom_directeur() %></td>
	                      </tr>
	                      
	                        <tr>
	                        <td style="font-size: 14px ;"><b>Montant du centre : </b></td>
	                        <td style="font-size: 14px ;"><%=dir.getMontant_centre() %></td>
	                      </tr>
