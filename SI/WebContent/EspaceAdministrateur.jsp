...
<li>
 <div class="imgcontainer">
  ...
  <li><a class="active" href="EspaceAdmnistrateur.jsp">Bienvenue</a></li>
	                ...
	                <div class=" col-md-9 col-lg-9 "> 
	                  <table class="table table-user-information">
		            	...
		            	<tr>
	                        ...
	                        <td style="font-size: 14px ;"> <%=admin.getNom_administrateur()%> </td>
	                      </tr>
	                      
	                      <tr>
	                        <td style="font-size: 14px ;"><b>Prenom : </b></td>
	                        <td style="font-size: 14px ;"><%=admin.getPrenom_administrateur()%></td>
	                      </tr>
	                   
	                       <tr>
			                     <td style="font-size: 14px ;"><b>Etablissement : </b></td>
			                     <td style="font-size: 14px ;"><%=admin.getEtab_administrateur()%></td>
	                     </tr>
	                   	  
	                         <tr>
	                        <td style="font-size: 14px ;"><b>Profession : </b></td>
	                        <td style="font-size: 14px ;"><%=admin.getProfession_administrateur()%></td>
	                      </tr>
	                      
	                        <tr>
	                        <td style="font-size: 14px ;"><b>Sexe : </b></td>
	                        <td style="font-size: 14px ;"><%=admin.getSexe_administrateur()%></td>
	                      </tr>
	                      
	                      <tr>
			                     <td style="font-size: 14px ;"><b>Adresse : </b></td>
			                     <td style="font-size: 14px ;"><%=admin.getAddress_administrateur()%></td>
	                     </tr>
	                      
	                      <tr>
	                        <td style="font-size: 14px ;"><b>Email : </b></td>
	                        <td style="font-size: 14px ;"><%=admin.getEmail_administrateur() %></td>
	                      </tr>
	                      
	                      <tr>
	                        <td style="font-size: 14px ;"><b>Telephone : </b></td>
	                        <td style="font-size: 14px ;"><%=admin.getNum_administrateur()%><br></td>    
	                      </tr>
